...
public class JsonArray implements JsonValue
{
	...
	public <T extends JsonValue> T getValue( int index )
	{
	...
	/**
	 * Sets a value at the given index, expanding the internal array.
	 * 
	 * @param index
	...
	/**
	 * Returns the number of JsonValues in this array.
	 * 
